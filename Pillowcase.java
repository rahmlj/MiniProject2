...
class Pillowcase {
  ...
  //accessor method return the total number in the pillowcase
  int getTotalCandyNum() {
    return totalCandyNum;
  }

  //getCandy method uses random number generator to determine the type of candy and adds to the bag
  void getCandy() {
